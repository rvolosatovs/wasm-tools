...
impl CanonicalFunctionSection {
    ...
    /// Defines a function to forward elements from the readable end of one
    /// `stream` to the writable end of another `stream` of the specified type.
    pub fn stream_forward(&mut self, ty: u32, async_: bool) -> &mut Self {
